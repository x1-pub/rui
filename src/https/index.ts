...
import type { HttpsRequest, HttpsResponse, HttpsAppOptions, HttpsContext, Next, HttpsMiddleware } from '../type.js'
 ...
 * HTTPS 服务器应用类
 */
class HttpsApp extends ServerFactory<HttpsRequest, HttpsResponse, Server, HttpsAppOptions> {
   ...
   */
  forceHttps = () => {
    return (ctx: HttpsContext, next: Next) => {
      // 设置 HSTS 头部
