import { CommonRequest, CommonResponse, HttpMethod, Middleware, RouteFunction, RouteHandler, Context, RuiError } from '../type.js'
...
interface RouteNode<T extends CommonRequest, D extends CommonResponse> {
  ...
  paramName?: string; // 参数名称，更清晰的命名
  children: Map<string, RouteNode<T, D>>;
  wildcardChild?: RouteNode<T, D>; // 通配符子节点
  paramChild?: RouteNode<T, D>; // 参数子节点
}
